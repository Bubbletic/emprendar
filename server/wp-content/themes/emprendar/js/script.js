  ...
  const swiperServices = new Swiper('.swiperServices', {
    ...
    on: {
      slideChange: function (ev) {
        const activeSlideIndex = swiperServices.activeIndex;
        const serviceTitle = document.getElementById("service_title");
        const serviceSubtitle = document.getElementById("service_subtitle");
        const serviceText = document.getElementById("service_text");

        serviceTitle.innerHTML = swiperServices.slides[activeSlideIndex].dataset.title;
        serviceSubtitle.innerHTML = swiperServices.slides[activeSlideIndex].dataset.subtitle;
        serviceText.innerHTML = swiperServices.slides[activeSlideIndex].dataset.service;
      }
    }
  });
});